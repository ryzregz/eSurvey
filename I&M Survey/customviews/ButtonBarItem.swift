...
extension UIBarButtonItem {
    ...
    func addBadge(with count: Int, withOffset offset: CGPoint = CGPoint.zero, andColor color: UIColor = UIColor.red, andFilled filled: Bool = true) {
...
class UIToolBarButton:UIBarButtonItem{
